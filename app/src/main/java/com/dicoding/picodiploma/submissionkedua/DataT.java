...
public class DataT implements Parcelable {
    ...
    public static final Parcelable.Creator<DataT> CREATOR = new Parcelable.Creator<DataT>() {
        @Override
        public DataT createFromParcel(Parcel source) {
            return new DataT(source);
        }

        @Override
        public DataT[] newArray(int size) {
            return new DataT[size];
        }
    };
}
